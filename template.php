 ...
 */
function UTKdrupalAdmin_views_bulk_operations_form_alter(&$form, &$form_state, $vbo) {
 ...
 */
function UTKdrupalAdmin_preprocess_html(&$vars) {
 ...
 */
function UTKdrupalAdmin_preprocess_page(&$vars) {
 ...
 */
function UTKdrupalAdmin_admin_block_content($variables) {
 ...
 */
function UTKdrupalAdmin_tablesort_indicator($variables) {
  $style = $variables['style'];
  $theme_path = drupal_get_path('theme', 'UTKdrupalAdmin');
  if ($style == 'asc') {
 ...
 */
function UTKdrupalAdmin_css_alter(&$css) {
  // Use UTKdrupalAdmin's vertical tabs style instead of the default one.
  if (isset($css['misc/vertical-tabs.css'])) {
    $css['misc/vertical-tabs.css']['data'] = drupal_get_path('theme', 'UTKdrupalAdmin') . '/css/vertical-tabs.css';
  }
  if (isset($css['misc/vertical-tabs-rtl.css'])) {
    $css['misc/vertical-tabs-rtl.css']['data'] = drupal_get_path('theme', 'UTKdrupalAdmin') . '/css/vertical-tabs-rtl.css';
  }
  // Use UTKdrupalAdmin's jQuery UI theme style instead of the default one.
  if (isset($css['misc/ui/jquery.ui.theme.css'])) {
    $css['misc/ui/jquery.ui.theme.css']['data'] = drupal_get_path('theme', 'UTKdrupalAdmin') . '/css/jquery.ui.theme.css';
  }
}

function UTKdrupalAdmin_breadcrumb($variables) {
  $sep = ' <span></span> ';
 ...
 * @see overlay.tpl.php
 */
function UTKdrupalAdmin_preprocess_overlay(&$variables) {
...
function UTKdrupalAdmin_system_info_alter(&$info, $file, $type) {
  if ($type == 'theme') {
